...
public class Script_Panel_Orc : MonoBehaviour
{
    public GameObject Panel_Orc;
    public GameObject Text_Enemy_Orc_01;
    public GameObject Text_Enemy_Orc_02;
    ...
    public void OpenPanel()
    {
        if (Panel_Orc != null)
        {
            ...
            Text_Enemy_Orc_01.GetComponent<Text>().text = "Damage to health = " + HealthDamageInt.ToString();
            ...
            Text_Enemy_Orc_02.GetComponent<Text>().text = "Gold Lost = " + gUIManager.PriceRandomInt.ToString();
